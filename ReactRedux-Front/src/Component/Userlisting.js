                                                ...
                                                <tr key={index}>
                                                    ...
                                                    <td>
                                                        <Link to={'/user/edit/' + item.id} className="btn btn-primary">
                                                            <FontAwesomeIcon icon={faEdit} className="edit-icon" /> Edit</Link> |
                                                        <button onClick={() => { handledelete(item.id) }} className="btn btn-danger" style={{height: "40px"}}>
                                                            <FontAwesomeIcon icon={faTrash} className="edit-icon" /> Delete</button>
                                                    </td>
                                                </tr>
                                            ))
                                        }
